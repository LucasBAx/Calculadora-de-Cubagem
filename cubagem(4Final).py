...
while loop:
 ...
 continuar = input("Deseja calcular a cubagem novamente? (sim/não): ").lower() #Da ao usuario a opção de continuar no programa ou fecha-lo

 if continuar != 'sim': #Caso seja escolhido uma opção diferente de "Sim", o codígo será fechado.
